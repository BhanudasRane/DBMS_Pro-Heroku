...
class sell_product(models.Model):
    ...
    bookset_image = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_a = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_b = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_c = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_d = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_e = models.ImageField(null=True,blank=True,upload_to="sell/Images")
    ...
    image_f = models.ImageField(null=True,blank=True,upload_to="sell/Images")
